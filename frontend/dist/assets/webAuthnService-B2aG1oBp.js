...
import { _ as s, __tla as __tla_0 } from "./pdf-utils-HZTV32cA.js";
import { s as u, a as c, b as d } from "./simplewebauthn-3qpiAaRi.js";
import { r as a, __tla as __tla_1 } from "./index-C63vm3Zv.js";
let l;
    ...
    l = {
        ...
        async login () {
            const t = await a("/api/oauth/webauthn/login/options"), e = await u(t), { getDeviceId: i } = await s(async ()=>{
                const { getDeviceId: r } = await import("./index-C63vm3Zv.js").then(async (m)=>{
                    await m.__tla;
                    return m;
                }).then((o)=>o.y);
                return {
